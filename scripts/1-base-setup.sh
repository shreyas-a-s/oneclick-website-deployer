...
# Installation
sudo apt update && sudo apt upgrade -y && sudo apt install apache2 php php-dev php-cli libapache2-mod-php php"$phpversion"-mbstring php-pgsql php-gd php-xml php-curl php-apcu php-uploadprogress phppgadmin wget -y
