...
# Installation
sudo apt-get -qq update && sudo apt-get -qq upgrade && sudo apt-get -qq install apache2 php php-dev php-cli libapache2-mod-php php"$phpversion"-mbstring php-pgsql php-gd php-xml php-curl php-apcu php-uploadprogress phppgadmin wget
